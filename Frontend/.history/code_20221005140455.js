...
function populatePosts(data, pagenumber){
    ...
    for (let x = 0; x < data.length; x++){
        ...
        .then(data => {
            ...
            for (let y = 0; y < data.length; y++){
                ...
                commentarrowupBtn.classList.add("arrowupBtn", "arrowBtn", "upvotecom");
                ...
                commentarrowdownBtn.classList.add("arrowdownBtn", "arrowBtn", "downvotcom");
    ...
    //////////////////////////////////////
    var commentarrowupbtns = document.querySelector(".upvotecom");
