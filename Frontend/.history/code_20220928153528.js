    ...
    // personal profile
        ...
        if(window.location.href.includes("profile")){
            ...
            followersBtn.addEventListener("click", function(){
                ...
                var followersOrFollowing = document.querySelector(".followersOrFollowing");
                close.addEventListener("click", function(){
                    followersOrFollowingListContainer.style.display = "none"
                    followersOrFollowingListContainer.innerHTML = "Followers: "
                })
            })
            ...
            followingBtn.addEventListener("click", function(){
                ...
                close.addEventListener("click", function(){
                    followersOrFollowingListContainer.style.display = "none"
                    followersOrFollowingListContainer.innerHTML = "Following: "
                })
            })
